...
if (!$_POST['blogname']) {
	$blogname = "FireBolt CMS";
} else {
	$blogname = $_POST['blogname'];
}
if (!$_POST['blogdescription']) {
	$blogdescription = "Just another FireBolt Blog.";
} else {
...
// first news post
$db->query("INSERT INTO `".DB_PREFIX."news` VALUES(0,1,1,'My First FireBolt CMS Post','','This is the first FireBolt CMS post. You may delete or modify this as you please!',UNIX_TIMESTAMP(),'',1,1)");

// first comment
$db->query("INSERT INTO `".DB_PREFIX."comments` VALUES(0,1,'Mr FireBolt CMS','','http://sorch.info/fireboltcms','This is the first FireBolt CMS comment!',UNIX_TIMESTAMP(),'')");
...
$db->query("INSERT INTO `".DB_PREFIX."widgets` VALUES(0,'Links','&bull; <a href=\"http://sorch.info/fireboltcms\">FireBolt CMS</a><br />&bull; <a href=\"${blogurl}admin/\">Admin Interface</a>')");
...
<br/><br />
Your FireBolt CMS installation is complete. You may <a href="${blogurl}admin/">Login</a> to the admin interface with the following credentials:
<br/>
...
function step_one() {
print "<h1 class=\"T\"><b>FireBolt CMS Installation:</b></h1><br/><div class=\"T\">Welcome to the FireBolt CMS installer! Firebolt is beta and should <b>not</b> be used on production servers.</div><br/><form name=\"installF\" action=\"install.php\" method=\"POST\"><h3 class=\"T\">
...
<head>
	...
	<title>FireBolt installation</title>
...
function foot() {
print '</div><p>&copy; 2010 FireBolt CMS Development Team</p>
</body>
</html>';
}
